...
const SeatLayout = () => {
        ...
        {Array.from({ length: count }, (_, i) => {
          ...
          return (
            <button
              ...
              className={`h-8 w-8 rounded border border-primary/60 text-[10px] cursor-pointer transition
                ${
                  selectedSeats.includes(seatId)
  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 pt-32 pb-20 gap-16">

      
      {/* AVAILABLE TIMINGS */}
      <div className="w-60 bg-primary/10 border border-primary/20 rounded-lg py-10 h-max mt-4 md:sticky md:top-24">
